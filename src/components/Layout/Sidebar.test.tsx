...
describe('Sidebar', () => {
  ...
  it('should not render overlay when sidebar is closed', () => {
    render(<Sidebar isOpen={false} onClose={mockOnClose} />, {wrapper: Wrapper})
  ...
  it('should have correct CSS classes when open', () => {
    const { container } = render(<Sidebar isOpen={true} onClose={mockOnClose} />, {wrapper: Wrapper})
  ...
  it('should have correct CSS classes when closed', () => {
    const { container } = render(<Sidebar isOpen={false} onClose={mockOnClose} />, {wrapper: Wrapper})
